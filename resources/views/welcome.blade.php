...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <h1 class="text-center">Getdabooks!</h1>
        <div class="input-group">
            <input type="text" class="form-control" onkeypress="handle(event)" placeholder="Spiderman or Lord of the rings or etc..." id="input">
            <div class="input-group-btn">
            <button class="btn btn-info" type="button" onclick="getbooks()">
